...
import com.advancedtelematic.libtuf.data.TufDataType.{Ec25519KeyType, Ec25519TufKey, Ec25519TufPrivateKey}
...
class CliKeyStorageSpec extends CliSpec {
  ...
  test("generates a key") {
    ...
    subject.genKeys(keyName, Ec25519KeyType, 256)

    val (pub, priv) = subject.readKeyPair(keyName).get

    pub shouldBe a[Ec25519TufKey]
    priv shouldBe a[Ec25519TufPrivateKey]
  }
