...
import com.advancedtelematic.keyserver.data.RepoClientDataType.RoleTypeToMetaPathOp
...
import com.advancedtelematic.keyserver.data.RepoClientDataType.{SnapshotRole, TargetsRole, TimestampRole}
